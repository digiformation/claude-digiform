      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              size="sm"
              className={`text-white rounded-full transition-all duration-500 ${isScrolled ? "px-4 h-8 text-xs" : "px-6"}`}
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button
              className="flex-1 text-white rounded-full h-14 text-base"
              style={{ background: "var(--blue)" }}
              onClick={() => setIsMobileMenuOpen(false)}
              asChild
            >
