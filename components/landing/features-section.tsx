...
const features = [
  {
    ...
    description: "Build digital literacy across your team to minimize resistance to change. We develop a clear, measurable roadmap aligned with your business objectives — OKRs, not vague aspirations. Change management included.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Process Automation & Low-Code",
    description: "We map your workflows end-to-end, then eliminate bottlenecks with no-code and low-code platforms your team can actually operate. No engineering team required. Citizen developers, not IT dependency.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Cybersecurity & Resilience",
    description: "Expanding your digital footprint introduces new risks. We implement CIS Controls IG1 — the SME-friendly cybersecurity framework — for practical protection without enterprise overhead. GDPR and NIS2 compliance included.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Funding Advisory",
    description: "End-to-end EU grant navigation: eligibility assessment, application preparation, project compliance management, and reimbursement claim support. Up to €120,000 available for eligible SMEs.",
    visual: "security",
  },
];
