      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-12 lg:gap-8">
            ...
            <div className="col-span-2">
              <a href="/" className="inline-flex items-center mb-6">
                <img src="/logo.svg" alt="DigiForm.gr" className="h-24 w-auto" />
              </a>

              <p className="text-muted-foreground leading-relaxed mb-8 max-w-xs">
                Digital business transformation for SMEs. Processes first. Technology second.
              </p>
        ...
        <div className="py-8 border-t border-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            2026 Digiform.gr. All rights reserved.
          </p>
